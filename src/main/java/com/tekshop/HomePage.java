	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			out.write("<!DOCTYPE html>\r\n"
					...
					+ "	        view_details_btn.style = \"cursor: pointer; border: 0.5px solid blue; border-radius: 5px; background-color:white;\";\r\n"
					+ "	\r\n"
					...
					+ "	        purchase_btn.style = \"cursor: pointer; border: 0.5px solid blue; border-radius: 5px; background-color:white;\";\r\n"
					+ "\r\n"
