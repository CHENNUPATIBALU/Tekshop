	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			...
			out.write("<!DOCTYPE html>\r\n"
					...
					+ "\r\n"
					+ "<body>\r\n"
					+ " <h1 id=\"logo-h\">TekShop</h1>\r\n"
					+ "	<div id=\"login-div\" style=\"width: max-content; text-align: center; margin: 0 auto; margin-top: 10%; display: block;\">\r\n"
					...
					+ "			document.getElementById('logo-h').style.display = 'none';\r\n"
					...
					+ "			document.getElementById('logo-h').style.display = 'block';\r\n"
