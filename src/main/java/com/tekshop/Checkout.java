...
public class Checkout extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		out.write("<!DOCTYPE html>\r\n"
				...
				+ "            <form action=\"CardPayment\" method=\"post\" id=\"card-form\">\r\n"
				...
				+ "            <form action=\"UpiPayment\" method=\"post\" id=\"upi-form\">\r\n"
		...
		out.append("<script>document.getElementById('card-form').onsubmit = ;</script>");
		out.append("<script>document.getElementById('upi-form').onsubmit = ;</script>");
	}
}
